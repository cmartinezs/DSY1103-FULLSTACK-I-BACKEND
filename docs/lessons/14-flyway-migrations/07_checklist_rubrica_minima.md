...
- [ ] `V1__Crear_tabla_tickets.sql` existe en mysql/ y supabase/
- [ ] `V2__Crear_tabla_usuarios.sql` existe en mysql/ y supabase/
- [ ] `V3__Agregar_relacion_tickets_usuarios.sql` existe en mysql/ y supabase/
