# Lección 12 — Actividad Individual
...
Crea `V1__Crear_tabla_tickets.sql` en ambas carpetas (mysql/ y supabase/):
...
Crea `V2__Crear_tabla_usuarios.sql`:
...
Crea `V3__Agregar_relacion_tickets_usuarios.sql`:
...
8. **Commit a Git**
   ...
   git add docs/lessons/12-flyway-migrations/
...
- Crea `V4__Crear_tabla_comentarios.sql` (tabla relacionada)
- Crea `V5__Agregar_columna_resuelto_por.sql` (agregar FK a usuario que resuelve)
