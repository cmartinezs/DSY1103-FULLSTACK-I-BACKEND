# Módulo 02 — Control de flujo moderno

> **Objetivo:** dominar todas las estructuras de control de Java y sus versiones modernas: switch expression, pattern matching en `if` y `switch`, y el bucle mejorado.
...
## 2.4 Pattern Matching en `instanceof` (Java 16+)
...
## 2.5 Pattern Matching en `switch` (Java 21) ⭐
...
### Ejercicio 2.1 — Switch expression
...
### Ejercicio 2.2 — FizzBuzz con control de flujo
...
### Ejercicio 2.3 — Pattern matching
...
*[← Módulo 01](./01_sintaxis_y_tipos.md) | [Índice](./README.md) | [Módulo 03 → Métodos](./03_metodos.md)*
